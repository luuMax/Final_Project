...
/**
 * The overarching structure for all chess pieces. Contains the type of the piece, 
 * the color, the location on the board, and moving logic.
 */
public abstract class Piece
{

    /**
     * Defines the types a piece can be
     */
    public enum Type{
        /**
         * A pawn piece
        ...
        PORTAL};
    /**
     * Defines the side/color a piece can be
     */
    public enum Side{
        /**
         * White side
