...
/**
 * Class for game window. Creates the chess board, active modifer panel, game log, draw button, and forfeit button.
 */
public class BoardUI extends JFrame {
     ...
     *              game object
     * @param net
     *              network manager to allow for multiplayer
     * @param loCol
     *              local color(for displaying board)
     */
     ...
     * 
     * @param piece
     *              piece for image to be added
     * @return
     *          the JLabel that contains the piece sprite
     */
     ...
     *      column
     * @return
     *      the JPanel that will represent a tile on a board
     */
    ...
    /**
     * Ends the game with the condition that a king was taken, therefore ending the game
     */
    public void endGame() {
    ...
    /**
     * Highlights a tile to a certain color to setting the background color to a different color
     * @param panel
     *          the tile to highlight
     * @param highLightColor
     *          the color to set the highlight to
     */
     ...
     * 
     * @param options
     *          List of options of modifiers for the player to select from
     */
     ...
     * @return
     *          true if the modifier is a placement modifier, false if not
     */
     ...
     * @param message
     *          message to be added to the game log
     */
     ...
     * @param piece
     *          piece where the image will be added
     * @param modPath
     *          the path to the icon image
     * @return
     *          the JPanel that contains the modified piece sprite with modifier icon overlay
     */
